#!/usr/bin/env python3
"""Validate all strains with PublicData equal to Yes."""
...
def database_result() -> list[str]:
    return unique_sorted_accessions(
        ...
        lambda record: field_equals(record, "PublicData", "Yes"),
    )


def main() -> None:
    accessions = database_result()
    write_accessions_tsv("Q010_public_data_yes.tsv", accessions)
