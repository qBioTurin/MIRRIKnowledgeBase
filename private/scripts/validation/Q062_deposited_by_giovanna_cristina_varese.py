#!/usr/bin/env python3
"""Validate all strains deposited by Giovanna Cristina Varese."""
...
def database_result() -> list[str]:
    ...
    return unique_sorted_accessions(
        ...
        lambda record: bool(person_ids.intersection(as_values(record.get("Depositor")))),
    )


def main() -> None:
    accessions = database_result()
    write_accessions_tsv("Q062_deposited_by_giovanna_cristina_varese.tsv", accessions)
