#!/usr/bin/env python3
"""Validate all strains collected in Torino."""
...
def database_result() -> list[str]:
    ...
    return unique_sorted_accessions(
        ...
        lambda record: locality_value(record, localities, "City") == "Torino",
    )


def main() -> None:
    accessions = database_result()
    write_accessions_tsv("Q048_geoorigin_city_torino.tsv", accessions)
