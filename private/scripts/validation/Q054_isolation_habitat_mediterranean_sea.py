#!/usr/bin/env python3
"""Validate all strains from Mediterranean Sea isolation habitat."""
...
def database_result() -> list[str]:
    return unique_sorted_accessions(
        ...
        lambda record: field_equals(record, "IsolationHabitat", "Mediterranean Sea"),
    )


def main() -> None:
    accessions = database_result()
    write_accessions_tsv("Q054_isolation_habitat_mediterranean_sea.tsv", accessions)
