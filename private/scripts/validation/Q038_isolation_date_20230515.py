#!/usr/bin/env python3
"""Validate all strains isolated on 20230515."""
...
def database_result() -> list[str]:
    return unique_sorted_accessions(
        ...
        lambda record: field_equals(record, "IsolationDate", "20230515"),
    )


def main() -> None:
    accessions = database_result()
    write_accessions_tsv("Q038_isolation_date_20230515.tsv", accessions)
