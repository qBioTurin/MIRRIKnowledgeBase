#!/usr/bin/env python3
"""Validate all strains with RecommendedTempGrowth equal to 24."""
...
def database_result() -> list[str]:
    return unique_sorted_accessions(
        ...
        lambda record: field_equals(record, "RecommendedTempGrowth", "24"),
    )


def main() -> None:
    accessions = database_result()
    write_accessions_tsv("Q069_recommended_temp_growth_24.tsv", accessions)
