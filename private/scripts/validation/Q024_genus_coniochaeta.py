#!/usr/bin/env python3
"""Validate all strains with Genus equal to Coniochaeta."""
...
def database_result() -> list[str]:
    return unique_sorted_accessions(
        ...
        lambda record: field_equals(record, "Genus", "Coniochaeta"),
    )


def main() -> None:
    accessions = database_result()
    write_accessions_tsv("Q024_genus_coniochaeta.tsv", accessions)
