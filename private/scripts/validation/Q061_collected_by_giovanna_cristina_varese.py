#!/usr/bin/env python3
"""Validate all strains collected by Giovanna Cristina Varese."""
...
def database_result() -> list[str]:
    ...
    return unique_sorted_accessions(
        ...
        lambda record: bool(person_ids.intersection(as_values(record.get("Collector")))),
    )


def main() -> None:
    accessions = database_result()
    write_accessions_tsv("Q061_collected_by_giovanna_cristina_varese.tsv", accessions)
