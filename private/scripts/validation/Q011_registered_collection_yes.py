#!/usr/bin/env python3
"""Validate all strains with RegisteredCollection equal to Yes."""
...
def database_result() -> list[str]:
    return unique_sorted_accessions(
        ...
        lambda record: field_equals(record, "RegisteredCollection", "Yes"),
    )


def main() -> None:
    accessions = database_result()
    write_accessions_tsv("Q011_registered_collection_yes.tsv", accessions)
