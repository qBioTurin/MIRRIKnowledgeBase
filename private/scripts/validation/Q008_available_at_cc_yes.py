#!/usr/bin/env python3
"""Validate all strains with AvailableAtCC equal to Yes."""
...
def database_result() -> list[str]:
    return unique_sorted_accessions(
        ...
        lambda record: field_equals(record, "AvailableAtCC", "Yes"),
    )


def main() -> None:
    accessions = database_result()
    write_accessions_tsv("Q008_available_at_cc_yes.tsv", accessions)
