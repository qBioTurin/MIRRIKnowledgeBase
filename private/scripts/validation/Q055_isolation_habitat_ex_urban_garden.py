#!/usr/bin/env python3
"""Validate all strains with IsolationHabitat equal to Ex urban garden."""
...
def database_result() -> list[str]:
    return unique_sorted_accessions(
        ...
        lambda record: field_equals(record, "IsolationHabitat", "Ex urban garden"),
    )


def main() -> None:
    accessions = database_result()
    write_accessions_tsv("Q055_isolation_habitat_ex_urban_garden.tsv", accessions)
