#!/usr/bin/env python3
"""Validate all strains with RecommendedTempGrowth equal to 25."""
...
def database_result() -> list[str]:
    return unique_sorted_accessions(
        ...
        lambda record: field_equals(record, "RecommendedTempGrowth", "25"),
    )


def main() -> None:
    accessions = database_result()
    write_accessions_tsv("Q068_recommended_temp_growth_25.tsv", accessions)
