#!/usr/bin/env python3
"""Validate all strains with NagoyaConditions equal to 1."""
...
def database_result() -> list[str]:
    return unique_sorted_accessions(
        ...
        lambda record: field_equals(record, "NagoyaConditions", "1"),
    )


def main() -> None:
    accessions = database_result()
    write_accessions_tsv("Q020_nagoya_conditions_1.tsv", accessions)
