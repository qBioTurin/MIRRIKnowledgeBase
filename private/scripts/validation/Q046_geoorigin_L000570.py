#!/usr/bin/env python3
"""Validate all strains with GeoOrigin equal to L000570."""
...
def database_result() -> list[str]:
    return unique_sorted_accessions(
        ...
        lambda record: field_equals(record, "GeoOrigin", "L000570"),
    )


def main() -> None:
    accessions = database_result()
    write_accessions_tsv("Q046_geoorigin_L000570.tsv", accessions)
