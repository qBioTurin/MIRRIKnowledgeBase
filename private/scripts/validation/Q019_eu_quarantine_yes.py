#!/usr/bin/env python3
"""Validate all strains marked as EU quarantine."""
...
def database_result() -> list[str]:
    return unique_sorted_accessions(
        ...
        lambda record: field_equals(record, "EUQuarantine", "Yes"),
    )


def main() -> None:
    accessions = database_result()
    write_accessions_tsv("Q019_eu_quarantine_yes.tsv", accessions)
