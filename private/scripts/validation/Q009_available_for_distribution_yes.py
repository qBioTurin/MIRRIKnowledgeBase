#!/usr/bin/env python3
"""Validate all strains with AvailableForDis equal to Yes."""
...
def database_result() -> list[str]:
    return unique_sorted_accessions(
        ...
        lambda record: field_equals(record, "AvailableForDis", "Yes"),
    )


def main() -> None:
    accessions = database_result()
    write_accessions_tsv("Q009_available_for_distribution_yes.tsv", accessions)
